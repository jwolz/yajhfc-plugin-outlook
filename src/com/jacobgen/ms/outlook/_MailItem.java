...
public class _MailItem extends Dispatch {

	public static final String componentName = "Outlook._MailItem";
	...
	*/
	...
	public _MailItem(String compName) {
		super(compName);
	}
	...
	public String getVotingOptions() {
		return Dispatch.get(this, "VotingOptions").toString();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param votingOptions an input-parameter of type String
	 */
	public void setVotingOptions(String votingOptions) {
		Dispatch.put(this, "VotingOptions", votingOptions);
	}
	...
	public String getVotingResponse() {
		return Dispatch.get(this, "VotingResponse").toString();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param votingResponse an input-parameter of type String
	 */
	public void setVotingResponse(String votingResponse) {
		Dispatch.put(this, "VotingResponse", votingResponse);
	}
	 ...
	 * @return the result is of type boolean
	 */
	public boolean getIsIPFax() {
		return Dispatch.get(this, "IsIPFax").changeType(Variant.VariantBoolean).getBoolean();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param isIPFax an input-parameter of type boolean
	 */
	public void setIsIPFax(boolean isIPFax) {
		Dispatch.put(this, "IsIPFax", new Variant(isIPFax));
	}
	 ...
	 * @return the result is of type boolean
	 */
	public boolean getHasCoverSheet() {
		return Dispatch.get(this, "HasCoverSheet").changeType(Variant.VariantBoolean).getBoolean();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param hasCoverSheet an input-parameter of type boolean
	 */
	public void setHasCoverSheet(boolean hasCoverSheet) {
		Dispatch.put(this, "HasCoverSheet", new Variant(hasCoverSheet));
	}
