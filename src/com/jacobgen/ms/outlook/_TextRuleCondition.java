...
public class _TextRuleCondition extends Dispatch {

	public static final String componentName = "Outlook._TextRuleCondition";
	...
	*/
	public _TextRuleCondition(Dispatch d) {
	...
	public _TextRuleCondition(String compName) {
		super(compName);
	}
