...
public class OlkOptionButtonEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkOptionButtonEvents";

	public OlkOptionButtonEvents() {
		super(componentName);
	}
	...
	*/
	public OlkOptionButtonEvents(Dispatch d) {
	...
	public OlkOptionButtonEvents(String compName) {
		super(compName);
	}
