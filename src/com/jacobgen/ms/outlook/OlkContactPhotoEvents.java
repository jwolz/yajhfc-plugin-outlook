...
public class OlkContactPhotoEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkContactPhotoEvents";

	public OlkContactPhotoEvents() {
		super(componentName);
	}
	...
	*/
	public OlkContactPhotoEvents(Dispatch d) {
	...
	public OlkContactPhotoEvents(String compName) {
		super(compName);
	}
