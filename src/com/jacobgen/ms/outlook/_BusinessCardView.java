...
public class _BusinessCardView extends Dispatch {

	public static final String componentName = "Outlook._BusinessCardView";
	...
	*/
	public _BusinessCardView(Dispatch d) {
	...
	public _BusinessCardView(String compName) {
		super(compName);
	}
...
//	}
	...
	public int getCardSize() {
		return Dispatch.get(this, "CardSize").changeType(Variant.VariantInt).getInt();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param cardSize an input-parameter of type int
	 */
	public void setCardSize(int cardSize) {
		Dispatch.put(this, "CardSize", new Variant(cardSize));
	}
