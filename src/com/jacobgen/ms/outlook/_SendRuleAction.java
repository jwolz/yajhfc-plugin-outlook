...
public class _SendRuleAction extends Dispatch {

	public static final String componentName = "Outlook._SendRuleAction";
	...
	*/
	public _SendRuleAction(Dispatch d) {
	...
	public _SendRuleAction(String compName) {
		super(compName);
	}
