...
public class OlkInfoBarEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkInfoBarEvents";

	public OlkInfoBarEvents() {
		super(componentName);
	}
	...
	*/
	public OlkInfoBarEvents(Dispatch d) {
	...
	public OlkInfoBarEvents(String compName) {
		super(compName);
	}
