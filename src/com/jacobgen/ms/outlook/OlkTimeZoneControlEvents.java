...
public class OlkTimeZoneControlEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkTimeZoneControlEvents";

	public OlkTimeZoneControlEvents() {
		super(componentName);
	}
	...
	*/
	public OlkTimeZoneControlEvents(Dispatch d) {
	...
	public OlkTimeZoneControlEvents(String compName) {
		super(compName);
	}
