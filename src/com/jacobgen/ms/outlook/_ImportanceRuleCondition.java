...
public class _ImportanceRuleCondition extends Dispatch {

	public static final String componentName = "Outlook._ImportanceRuleCondition";
	...
	*/
	public _ImportanceRuleCondition(Dispatch d) {
	...
	public _ImportanceRuleCondition(String compName) {
		super(compName);
	}
