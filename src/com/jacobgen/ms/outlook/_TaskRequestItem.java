...
public class _TaskRequestItem extends Dispatch {

	public static final String componentName = "Outlook._TaskRequestItem";
	...
	*/
	public _TaskRequestItem(Dispatch d) {
	...
	public _TaskRequestItem(String compName) {
		super(compName);
	}
