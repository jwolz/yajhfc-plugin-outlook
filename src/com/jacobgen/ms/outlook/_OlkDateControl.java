...
public class _OlkDateControl extends Dispatch {

	public static final String componentName = "Outlook._OlkDateControl";
	...
	*/
	public _OlkDateControl(Dispatch d) {
	...
	public _OlkDateControl(String compName) {
		super(compName);
	}
...
//	}
	...
	public void setDate(java.util.Date date) {
		Dispatch.put(this, "Date", new Variant(date));
	}
...
//	}
	...
	public boolean getShowNoneButton() {
		return Dispatch.get(this, "ShowNoneButton").changeType(Variant.VariantBoolean).getBoolean();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param showNoneButton an input-parameter of type boolean
	 */
	public void setShowNoneButton(boolean showNoneButton) {
		Dispatch.put(this, "ShowNoneButton", new Variant(showNoneButton));
	}
