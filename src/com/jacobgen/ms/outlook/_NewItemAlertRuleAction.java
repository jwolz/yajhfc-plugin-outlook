...
public class _NewItemAlertRuleAction extends Dispatch {

	public static final String componentName = "Outlook._NewItemAlertRuleAction";
	...
	*/
	public _NewItemAlertRuleAction(Dispatch d) {
	...
	public _NewItemAlertRuleAction(String compName) {
		super(compName);
	}
