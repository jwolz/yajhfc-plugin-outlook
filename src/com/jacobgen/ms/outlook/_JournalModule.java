...
public class _JournalModule extends Dispatch {

	public static final String componentName = "Outlook._JournalModule";
	...
	*/
	public _JournalModule(Dispatch d) {
	...
	public _JournalModule(String compName) {
		super(compName);
	}
