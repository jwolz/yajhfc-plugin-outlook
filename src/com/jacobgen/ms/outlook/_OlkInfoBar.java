...
public class _OlkInfoBar extends Dispatch {

	public static final String componentName = "Outlook._OlkInfoBar";
	...
	*/
	...
	public _OlkInfoBar(String compName) {
		super(compName);
	}
