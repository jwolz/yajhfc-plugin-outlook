...
public class _ContactsModule extends Dispatch {

	public static final String componentName = "Outlook._ContactsModule";
	...
	*/
	public _ContactsModule(Dispatch d) {
	...
	public _ContactsModule(String compName) {
		super(compName);
	}
