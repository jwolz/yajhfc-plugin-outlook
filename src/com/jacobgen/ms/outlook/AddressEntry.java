...
public class AddressEntry extends Dispatch {

	public static final String componentName = "Outlook.AddressEntry";
	...
	*/
	public AddressEntry(Dispatch d) {
	...
	public AddressEntry(String compName) {
		super(compName);
	}
