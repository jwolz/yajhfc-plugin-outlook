...
public class OlkSenderPhotoEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkSenderPhotoEvents";

	public OlkSenderPhotoEvents() {
		super(componentName);
	}
	...
	*/
	public OlkSenderPhotoEvents(Dispatch d) {
	...
	public OlkSenderPhotoEvents(String compName) {
		super(compName);
	}
