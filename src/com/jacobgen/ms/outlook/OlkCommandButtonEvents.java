...
public class OlkCommandButtonEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkCommandButtonEvents";

	public OlkCommandButtonEvents() {
		super(componentName);
	}
	...
	*/
	public OlkCommandButtonEvents(Dispatch d) {
	...
	public OlkCommandButtonEvents(String compName) {
		super(compName);
	}
