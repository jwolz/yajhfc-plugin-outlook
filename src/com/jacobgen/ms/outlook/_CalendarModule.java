...
public class _CalendarModule extends Dispatch {

	public static final String componentName = "Outlook._CalendarModule";
	...
	*/
	public _CalendarModule(Dispatch d) {
	...
	public _CalendarModule(String compName) {
		super(compName);
	}
	...
	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @return the result is of type _NavigationGroups
	 */
	public _NavigationGroups getNavigationGroups() {
		return new _NavigationGroups(Dispatch.get(this, "NavigationGroups").toDispatch());
	}
