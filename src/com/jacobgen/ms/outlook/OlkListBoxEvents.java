...
public class OlkListBoxEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkListBoxEvents";

	public OlkListBoxEvents() {
		super(componentName);
	}
	...
	*/
	public OlkListBoxEvents(Dispatch d) {
	...
	public OlkListBoxEvents(String compName) {
		super(compName);
	}
