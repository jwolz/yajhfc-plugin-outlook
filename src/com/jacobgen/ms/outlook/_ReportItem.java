...
public class _ReportItem extends Dispatch {

	public static final String componentName = "Outlook._ReportItem";
	...
	*/
	...
	public _ReportItem(String compName) {
		super(compName);
	}
