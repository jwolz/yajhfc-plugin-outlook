...
public class ResultsEvents extends Dispatch {

	public static final String componentName = "Outlook.ResultsEvents";

	public ResultsEvents() {
		super(componentName);
	}
	...
	*/
	public ResultsEvents(Dispatch d) {
	...
	public ResultsEvents(String compName) {
		super(compName);
	}
