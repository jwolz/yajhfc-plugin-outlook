...
public class _MailModule extends Dispatch {

	public static final String componentName = "Outlook._MailModule";
	...
	*/
	...
	public _MailModule(String compName) {
		super(compName);
	}
