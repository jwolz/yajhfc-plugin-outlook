...
public class _TaskRequestAcceptItem extends Dispatch {

	public static final String componentName = "Outlook._TaskRequestAcceptItem";
	...
	*/
	public _TaskRequestAcceptItem(Dispatch d) {
	...
	public _TaskRequestAcceptItem(String compName) {
		super(compName);
	}
