...
public class _RemoteItem extends Dispatch {

	public static final String componentName = "Outlook._RemoteItem";
	...
	*/
	...
	public _RemoteItem(String compName) {
		super(compName);
	}
	...
	public boolean getHasAttachment() {
		return Dispatch.get(this, "HasAttachment").changeType(Variant.VariantBoolean).getBoolean();
	}
	...
	public String getRemoteMessageClass() {
		return Dispatch.get(this, "RemoteMessageClass").toString();
	}
	...
	public int getTransferSize() {
		return Dispatch.get(this, "TransferSize").changeType(Variant.VariantInt).getInt();
	}
	...
	public int getTransferTime() {
		return Dispatch.get(this, "TransferTime").changeType(Variant.VariantInt).getInt();
	}
