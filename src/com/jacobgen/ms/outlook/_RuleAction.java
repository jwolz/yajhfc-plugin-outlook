...
public class _RuleAction extends Dispatch {

	public static final String componentName = "Outlook._RuleAction";
	...
	*/
	...
	public _RuleAction(String compName) {
		super(compName);
	}
