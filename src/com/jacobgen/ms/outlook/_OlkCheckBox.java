...
public class _OlkCheckBox extends Dispatch {

	public static final String componentName = "Outlook._OlkCheckBox";
	...
	*/
	public _OlkCheckBox(Dispatch d) {
	...
	public _OlkCheckBox(String compName) {
		super(compName);
	}
...
//	}
	 ...
	 * @return the result is of type boolean
	 */
	public boolean getTripleState() {
		return Dispatch.get(this, "TripleState").changeType(Variant.VariantBoolean).getBoolean();
	}

	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param tripleState an input-parameter of type boolean
	 */
	public void setTripleState(boolean tripleState) {
		Dispatch.put(this, "TripleState", new Variant(tripleState));
	}
