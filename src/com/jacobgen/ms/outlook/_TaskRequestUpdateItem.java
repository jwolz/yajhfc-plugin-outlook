...
public class _TaskRequestUpdateItem extends Dispatch {

	public static final String componentName = "Outlook._TaskRequestUpdateItem";
	...
	*/
	public _TaskRequestUpdateItem(Dispatch d) {
	...
	public _TaskRequestUpdateItem(String compName) {
		super(compName);
	}
