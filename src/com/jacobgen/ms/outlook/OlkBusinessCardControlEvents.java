...
public class OlkBusinessCardControlEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkBusinessCardControlEvents";

	public OlkBusinessCardControlEvents() {
		super(componentName);
	}
	...
	*/
	public OlkBusinessCardControlEvents(Dispatch d) {
	...
	public OlkBusinessCardControlEvents(String compName) {
		super(compName);
	}
