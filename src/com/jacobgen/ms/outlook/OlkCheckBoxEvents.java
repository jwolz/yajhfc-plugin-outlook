...
public class OlkCheckBoxEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkCheckBoxEvents";

	public OlkCheckBoxEvents() {
		super(componentName);
	}
	...
	*/
	public OlkCheckBoxEvents(Dispatch d) {
	...
	public OlkCheckBoxEvents(String compName) {
		super(compName);
	}
