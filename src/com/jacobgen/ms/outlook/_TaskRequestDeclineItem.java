...
public class _TaskRequestDeclineItem extends Dispatch {

	public static final String componentName = "Outlook._TaskRequestDeclineItem";
	...
	*/
	public _TaskRequestDeclineItem(Dispatch d) {
	...
	public _TaskRequestDeclineItem(String compName) {
		super(compName);
	}
	...
	/**
	 * Wrapper for calling the ActiveX-Method with input-parameter(s).
	 * @param addToTaskList an input-parameter of type boolean
	 * @return the result is of type TaskItem
	 */
	public TaskItem getAssociatedTask(boolean addToTaskList) {
		return new TaskItem(Dispatch.call(this, "GetAssociatedTask", new Variant(addToTaskList)).toDispatch());
	}
