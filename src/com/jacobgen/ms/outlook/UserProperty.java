...
public class UserProperty extends Dispatch {

	public static final String componentName = "Outlook.UserProperty";
	...
	*/
	public UserProperty(Dispatch d) {
	...
	public UserProperty(String compName) {
		super(compName);
	}
