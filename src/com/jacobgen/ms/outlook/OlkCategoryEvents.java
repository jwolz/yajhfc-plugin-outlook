...
public class OlkCategoryEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkCategoryEvents";

	public OlkCategoryEvents() {
		super(componentName);
	}
	...
	*/
	public OlkCategoryEvents(Dispatch d) {
	...
	public OlkCategoryEvents(String compName) {
		super(compName);
	}
