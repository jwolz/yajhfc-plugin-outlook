...
public class OlkTimeControlEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkTimeControlEvents";

	public OlkTimeControlEvents() {
		super(componentName);
	}
	...
	*/
	public OlkTimeControlEvents(Dispatch d) {
	...
	public OlkTimeControlEvents(String compName) {
		super(compName);
	}
