...
public class _TasksModule extends Dispatch {

	public static final String componentName = "Outlook._TasksModule";
	...
	*/
	public _TasksModule(Dispatch d) {
	...
	public _TasksModule(String compName) {
		super(compName);
	}
