...
public class _NotesModule extends Dispatch {

	public static final String componentName = "Outlook._NotesModule";
	...
	*/
	public _NotesModule(Dispatch d) {
	...
	public _NotesModule(String compName) {
		super(compName);
	}
