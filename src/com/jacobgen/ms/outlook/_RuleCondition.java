...
public class _RuleCondition extends Dispatch {

	public static final String componentName = "Outlook._RuleCondition";
	...
	*/
	public _RuleCondition(Dispatch d) {
	...
	public _RuleCondition(String compName) {
		super(compName);
	}
