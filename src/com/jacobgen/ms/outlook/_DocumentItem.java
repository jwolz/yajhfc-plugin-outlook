...
public class _DocumentItem extends Dispatch {

	public static final String componentName = "Outlook._DocumentItem";
	...
	*/
	public _DocumentItem(Dispatch d) {
	...
	public _DocumentItem(String compName) {
		super(compName);
	}
