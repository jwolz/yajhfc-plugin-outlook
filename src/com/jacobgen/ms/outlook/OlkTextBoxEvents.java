...
public class OlkTextBoxEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkTextBoxEvents";

	public OlkTextBoxEvents() {
		super(componentName);
	}
	...
	*/
	public OlkTextBoxEvents(Dispatch d) {
	...
	public OlkTextBoxEvents(String compName) {
		super(compName);
	}
