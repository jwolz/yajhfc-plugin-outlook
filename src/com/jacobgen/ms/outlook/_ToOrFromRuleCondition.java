...
public class _ToOrFromRuleCondition extends Dispatch {

	public static final String componentName = "Outlook._ToOrFromRuleCondition";
	...
	*/
	public _ToOrFromRuleCondition(Dispatch d) {
	...
	public _ToOrFromRuleCondition(String compName) {
		super(compName);
	}
