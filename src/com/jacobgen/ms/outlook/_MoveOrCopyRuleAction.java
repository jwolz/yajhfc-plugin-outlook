...
public class _MoveOrCopyRuleAction extends Dispatch {

	public static final String componentName = "Outlook._MoveOrCopyRuleAction";
	...
	*/
	public _MoveOrCopyRuleAction(Dispatch d) {
	...
	public _MoveOrCopyRuleAction(String compName) {
		super(compName);
	}
	 ...
	 */
	public void setFolder(MAPIFolder folder) {
		Dispatch.put(this, "Folder", folder);
	}
