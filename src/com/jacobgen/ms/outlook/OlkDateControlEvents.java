...
public class OlkDateControlEvents extends Dispatch {

	public static final String componentName = "Outlook.OlkDateControlEvents";

	public OlkDateControlEvents() {
		super(componentName);
	}
	...
	*/
	public OlkDateControlEvents(Dispatch d) {
	...
	public OlkDateControlEvents(String compName) {
		super(compName);
	}
